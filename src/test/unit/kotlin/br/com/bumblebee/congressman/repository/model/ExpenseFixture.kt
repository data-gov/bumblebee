...
val RECEIPT_FIXTURE = Receipt(RECEIPT_ID, RECEIPT_DATE, RECEIPT_KIND_ID, RECEIPT_NUMBER, URL, RECEIPT_VALUE, RECEIPT_KIND)
val PROVIDER_FIXTURE = Provider(PROVIDER_NAME, PROVIDER_ID)
val EXPENSE_FIXTURE = Expense(YEAR, MONTH, LOT_ID, PARCEL, KIND, NET_VALUE, RECEIPT_FIXTURE, REFUND_NUMBER, GLOSS_VALUE, PROVIDER_FIXTURE)
